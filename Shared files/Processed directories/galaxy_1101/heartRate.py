...
fileToRead = "com.samsung.shealth.tracker.heart_rate.202112041101.csv"
dataType = "HeartRate"
    ...
    for item in toBeRemovedHeartRate:
        if header.strip() == item:
            try:
                ...
                pass
obsoleteColumns.append("com.samsung.health.heart_rate.binning_data")
# usefulColumns.remove("com.samsung.health.heart_rate.binning_data")

print(obsoleteColumns)
