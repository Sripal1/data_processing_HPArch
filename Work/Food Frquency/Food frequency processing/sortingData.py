...
fileToRead = "com.samsung.shealth.food_frequent.202111291535 - şığçşğ - şığçşğ.csv"
# do not leave spaces inbetween the words (recommend camel casing)
dataType = "foodFrequency"
...
def sortData():
    ...
    csv_list.sort(key=lambda l: l[1], reverse=False)
    newList = []
    for i in csv_list:
        tempList = []
        counter = 0
