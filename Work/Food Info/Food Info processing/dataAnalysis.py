...
toBeRemoved=["provider_food_id","datauuid","create_time"]
...
toBeAdded=["sugar","vitamin_d"]
for item in toBeAdded:
    try:
        obsoleteColumns.remove(item)
        usefulColumns.append(item)
    except:
        print("Couldn't add column to file")
