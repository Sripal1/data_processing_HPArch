...
fileToRead = "com.samsung.health.water_intake.202111291535 - şığçşğ.csv"
dataType = "WaterIntake"  #do not leave spaces inbetween the words (recommend camel casing)
